...
COPY aircraft_type
FROM '/var/lib/postgresql/csvs/aircraft_type.csv'
DELIMITER ','
CSV Header;

COPY aircraft_layout
FROM '/var/lib/postgresql/csvs/aircraft_layout.csv'
DELIMITER ','
CSV Header;

COPY aircraft
FROM '/var/lib/postgresql/csvs/aircraft.csv'
DELIMITER ','
CSV Header;

COPY country
FROM '/var/lib/postgresql/csvs/country.csv'
DELIMITER ','
CSV Header;

COPY city
FROM '/var/lib/postgresql/csvs/city.csv'
DELIMITER ','
CSV Header;

COPY airport
FROM '/var/lib/postgresql/csvs/airport.csv'
DELIMITER ','
CSV Header;

COPY flight
FROM '/var/lib/postgresql/csvs/flight.csv'
DELIMITER ','
CSV Header;
